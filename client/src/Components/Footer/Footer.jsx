      ...
      <footer>
        <div className="subsription-div ">
          <div className="subsription-text">
            <h2 className="child-heading">KNOW IT ALL FIRST!</h2>
            <p>
        ...
        <div className="footer-content">
          ...
          <div className="footer-col">
            ...
            {FooterLinksData.filter(
              (category) => category.category === "Account"
            ).map((filteredCategory) => (
              <li key={filteredCategory.id}>
                <Link to={filteredCategory.url}>{filteredCategory.title}</Link>
              </li>
            ))}
          </div>
          <div className="footer-col">
            ...
            {FooterLinksData.filter(
              ...
              <li key={filteredCategory.id}>
                <p>
                  {" "}
                  <span>
                    <filteredCategory.iconName className="footer-links-icons" />{" "}
                    &nbsp;
                  </span>
