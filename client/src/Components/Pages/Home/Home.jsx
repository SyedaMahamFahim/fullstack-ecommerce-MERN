        ...
        <>
          ...
          <div className="container mt-5">
            <div className="row mt-5">
              <h2 className="text-center mb-5">Lastest Collection</h2>
    ...
    <div className="container-fluid hero-section">
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="hero-section-contain mt-5">
          <h1>SUMMER SALE</h1>
          <h3>FASHION TRENDS</h3>
          <h6 className="lead">SPECIAL OFFER</h6>
...
const ProductCategories = () => {
  return (
    ...
    <div className="text-center mt-5">
      <h2 className="mt-5">Spring 2020 collection</h2>
    </div>
            ...
            <Link to="/shop">
              <div className="product-col-left flex">
                <div className="product-col-content">
                  <h2 className="sm-title">WOMEN's Collection </h2>
            ...
            <div className="product-col-right">
              <Link to="/shop">
                <div className="product-col-r-top flex">
                  <div className="product-col-content">
                    <h2 className="sm-title">Accessories </h2>
                    <button type="button" className="btn btn-dark">
                      Shop now
                    </button>
                  </div>
              ...
              <div className="product-col-r-bottom">
                ...
                <div className="flex">
                  <Link to="/shop">
                    <div className="product-col-content">
                      <h2 className="sm-title">Glasses </h2>
...
const HomeIcons = () => {
  return (
    <>
      <div className="container mt-5" >
        <section
          className="border-section small-section mt-5"
          
        >
          <div className="row" >
            <div
              className="service-block col-md-4"
